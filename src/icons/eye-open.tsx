...
export const EyeOpenIcon = React.forwardRef<Svg, IconProps>(
  ({
    ...
    return (
      ...
      >
        <Path
          d="M18.8294 13.1734C20.3907 14.7347 20.3907 17.2694 18.8294 18.8334C17.268 20.3947 14.7334 20.3947 13.1694 18.8334C11.608 17.272 11.608 14.7374 13.1694 13.1734C14.7334 11.6094 17.2667 11.6094 18.8294 13.1734Z"
          stroke={color}
